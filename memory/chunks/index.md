...
* [Slugged draft chunk model](slugged-draft-chunk-model.md) - ⬜ pending · medium · Persist planned chunks as draft OKF files early and make slug/file identity the canonical identifier used by gather/server/UI payloads.
